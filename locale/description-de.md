...
| Platz 1 | Platz 2 | Platz 3 | Platz 4 | Unentschieden (übrige KIs) |
|---|---|---|---|---|
| 3 SP | 2 SP | 1 SP | 0 SP | 2 SP |


**Bonuspunkte:**  
Weiterhin gibt es für die einzelnen Phasen die folgenden Bonus-Challenges, für die es **Bonuspunkte (BP)** gibt. Diese sind äquivalent zu Siegpunkten, beeinflussen aber nicht das Matchmaking:
...
- **Spammer:** in einem Spiel das größte Verhältnis $\frac{\text{Anzahl rekrutierte Truppen}}{\text{erwirtschaftetes Gold}}$ erlangt
...
- **Teamwork:** (2 vs. 2) das Verhältnis $\frac{\text{produzierte Truppen KI 1}}{\text{produzierte Truppen KI 2}}$ beider KIs in einem Spiel am nächsten an 1
...
- **Minimalist:** beste (minimale) Bilanz $\frac{\text{produzierte harte Ressourcen (Stein, Eisen, Pech)}}{\text{Spielzeit}}$ über die gesamte Phase
...
Es werden jede Runde $10 \cdot X$ APs ausgeschüttet, wobei $X$ die **Anzahl der teilnehmenden KIs** ist. Die Ausschüttung funktioniert wie folgt:
...
- Die für die im Video **gezeigten KIs** ausgeschütteten **APs** entsprechen dann dem Verhältnis $\frac{\text{WT}}{\text{GWT}}$.
- Beispiel: Die Watchtime für ein Video ist `WT = 100h` und die gesamte Watchtime aller Videos der Runde entspricht `GWT = 1000h`. Bei 20 teilnehmenden KIs bekommen die beiden KIs aus dem Video für diese Runde jeweils $\frac{\text{100}}{\text{1000}} \cdot (10 \cdot 20) = 20 AP$.

| Option | (AP) Kosten | Beschreibung |
|--------|-------------|--------------|
| **[0]** | – | **Hotfixes** sind frei, z. B. bei **Pathfinding-Problemen**, schlecht gesetzten **AIC-Parametern** oder zum **Hinzufügen von Häusern**. |
| **[1]** | 10 | **Anzahl** eines bestehenden **Einheitenslots** um bis zu 10 verändern (bei Belagerungsgeräten nur 1). |
| **[2]** | 15 | Einen **neuen Einheitenslot** mit bestehender Einheit hinzufügen (bis zu 10 Einheiten). |
| **[3]** | 20 | Einen **neuen Einheitentyp** einführen, den die KI bisher nicht verwendet hat. |
| **[4]** | 4 | Anzahl von **AIC-Wirtschaftsgebäuden** um 1 verändern. |
| **[5]** | 8 | Einen anderen **AIC-Parameter** anpassen. |
| **[6]** | 5 | Ein bestehendes **AIV-Wirtschaftsgebäude** oder 2 **Angstfaktorgebäude** erneut hinzufügen oder entfernen. |
| **[7]** | 10 | Ein bestehendes **AIV-Burggebäude** (Rekrutierung, Tore, Türme) erneut hinzufügen oder entfernen **oder** bis zu 10 Teile Wall/Wassergraben/Mördergrube/Pech. |
| **[8]** | 15 | Einen neuen **Gebäudetyp** in der AIV einführen (freischalten). |
| **[9]** | 40 | **Build-Order** anpassen. |
| **[10]** | 50 | **Lordstärke auf 2 erhöhen**. |
| **[11]** | 75 | **Starttruppen** anpassen, bis zu einem Maximum von 15. |
...
[4] MaxFarms um 3 erhöhen (3 $\cdot$ 4 AP)  
[5] Farmslot 1 und 2 auf Getreidefarmen ändern (2 $\cdot$ 8 AP)  
[6] 2 weitere AIV Holzfäller hinzufügen (2 $\cdot$ 5 AP)  
[8] Mühle und Bäckerei freischalten (2 $\cdot$ 15 AP)  
[6] Eine Mühle und 8 Bäckereien platzieren (9 $\cdot$ 5 AP)  
Insgesamt würde dies **113 AP** kosten.

Um einer KI einen zweiten Burg-Vorhof hinzuzufügen:  
[7] Ein weiteres großes Torhaus mit Zugbrücke hinzufügen (2 $\cdot$ 10 AP)  
[7] 78 Wall- bzw. Zinnwall-Felder platzieren (8 $\cdot$ 10 AP)
[7] 22 Felder Wassergraben hinzufügen (3 $\cdot$ 10 AP)
